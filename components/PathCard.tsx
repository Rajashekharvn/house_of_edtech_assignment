        ...
        <Card className="hover:shadow-md transition-shadow group flex flex-col h-full border-slate-200 dark:border-border dark:bg-card">
            ...
            <CardContent className="pb-1 sm:pb-3 flex-1">
                <div className="space-y-1.5 sm:space-y-3">
                    ...
                    <div className="hidden sm:flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 font-medium pt-1">
                        <BookOpen className="w-3.5 h-3.5 shrink-0" />
                        <span className="truncate">{path.completedCount} / {path._count.resources} <span className="hidden sm:inline">Resources</span> completed</span>
                    </div>
                </div>
            </CardContent>
